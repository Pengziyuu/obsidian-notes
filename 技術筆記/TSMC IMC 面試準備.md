...
> [!warning] 必備技能
> - [x] 至少精通一種程式語言（Python / SQL / C# / Java / React / TensorFlow）
> - [x] 熟悉機器學習演算法
> - [x] 資料視覺化能力
> - [x] 統計分析方法
> - [x] 系統開發生命週期 (SDLC)
...
> [!info] 深入學習
> 本職位涉及的核心技術（雲原生、K8s、SRE、IaC、DevOps、MLOps、Go、SAS…）已整理為獨立深度筆記，請見 ➡️ [[IMC 技術領域 MOC]]
> 
> 該 MOC 包含：
> - 五大主題群組筆記（原理 + 範例 + IMC 場景）
> - 面試考點熱度排序
> - 6 週學習路徑建議
> - 面試前 30 分鐘 Cheat Sheet
